...
Bool_t FTAna::Process(Long64_t entry)
{
 ...
 if(lep_0_pt<28000) i=0;
 else if(lep_0_pt<60000) i=1;
 else if(lep_0_pt<90000) i=2;
 else if(lep_0_pt<130000) i=3;
 else i=4;

 if(lep_1_pt<28000) k=0;
 else if(lep_1_pt<60000) k=1;
 else if(lep_1_pt<90000) k=2;
 else if(lep_1_pt<130000) k=3;
 else k=4;
...
void FTAna::BookHistograms()
{
  ...
  h.ss_lep_pt_Q[0] = new TH1D("ss_lep0_pt","",5, pTBins);
  h.ss_lep_pt_Q[1] = new TH1D("ss_lep1_pt","",5, pTBins);
  h.ss_lep_pt_Q[2] = new TH1D("ss_lep2_pt","",5, pTBins);
  ...
  h.ss_pt_eta[0] = new TH2D("ss_pt_eta_0","" ,6, etaBins,5, pTBins);
  h.ss_pt_eta[1] = new TH2D("ss_pt_eta_1","" ,6, etaBins,5, pTBins);
  ...
  h.os_lep_pt_Q[0] = new TH1D("os_lep0_pt","",5, pTBins);
  h.os_lep_pt_Q[1] = new TH1D("os_lep1_pt","",5, pTBins);
  h.os_lep_pt_Q[2] = new TH1D("os_lep2_pt","",5, pTBins);
  ...
  h.os_pt_eta[0] = new TH2D("os_pt_eta_0","" ,6, etaBins,5, pTBins);
  h.os_pt_eta[1] = new TH2D("os_pt_eta_1","" ,6, etaBins,5, pTBins);
